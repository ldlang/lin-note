import{_ as s,o as a,c as t,e as p}from"./app-f2be1002.js";const e={};function c(o,n){return a(),t("div",null,[...n[0]||(n[0]=[p(`<p>node.js</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>node也是js的运行环境 但是无法调用dom、bom和ajax等的流浪器内置的api
