...
<span class="token function">git</span> cherry-pick <span class="token parameter variable">--abort</span>
   取消操作并返回到预排序状态。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ol><h3 id="同时推送两个远程仓库" tabindex="-1"><a class="header-anchor" href="#同时推送两个远程仓库" aria-hidden="true">#</a> 同时推送两个远程仓库</h3><ol><li><p>在原有的仓库上再添加一个远程地址</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> remote set-url <span class="token parameter variable">--add</span> origin 远端地址
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li><li><p>查看远端地址，要有两个 push 地址 <img src="`+l+`" alt="push地址">]</p></li><li><p>推送代码，正常使用 push 就可以同时推送两个远端了</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> push
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li></ol><h3 id="git-无法推送" tabindex="-1"><a class="header-anchor" href="#git-无法推送" aria-hidden="true">#</a> git 无法推送</h3><ol><li>打开代理软件</li><li>在电脑上看代理的地址</li><li>配置 git 的代理地址，保持和电脑上的代理地址和端口号一致</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> config <span class="token parameter variable">--global</span> http.proxy http://127.0.0.1:7890
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><ol start="4"><li>重新推送代码</li><li>取消代理</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> config <span class="token parameter variable">--global</span> <span class="token parameter variable">--unset</span> http.proxy
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,28)])])}const p=s(t,[["render",d],["__file","index.html.vue"]]);export{p as default};
