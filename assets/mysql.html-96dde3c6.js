import{_ as e,o as n,c as s,e as i}from"./app-3ec42fe6.js";const l={},a=i(`<p>启动与停止</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>net start mysql80
net stop mysql80
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ol>`,31),d=[a];function t(r,v){return n(),s("div",null,d)}const c=e(l,[["render",t],["__file","mysql.html.vue"]]);export{c as default};
