import{_ as n,o as s,c as a,e}from"./app-7ed3cb39.js";const p={},t=e(`<h1 id="模块" tabindex="-1"><a class="header-anchor" href="#模块" aria-hidden="true">#</a> 模块</h1><p>基本上和 es6 的导入模块语法一致，能够导入类型。</p><h2 id="ts-中的模块" tabindex="-1"><a class="header-anchor" href="#ts-中的模块" aria-hidden="true">#</a> ts 中的模块</h2><h3 id="import-type" tabindex="-1"><a class="header-anchor" href="#import-type" aria-hidden="true">#</a> import type</h3><p>只能导入类型，不能导入值，如果导入的是值就会报错。</p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token comment">// app.ts 导出</span>
