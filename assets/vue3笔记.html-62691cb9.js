import{_ as n,o as s,c as a,b as t}from"./app-46ca9d3b.js";const e={},p=t(`<h3 id="vite" tabindex="-1"><a class="header-anchor" href="#vite" aria-hidden="true">#</a> vite</h3><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code>使用vite创建vue<span class="token operator">-</span>cli
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,90),o=[p];function c(l,i){return s(),a("div",null,o)}const r=n(e,[["render",c],["__file","vue3笔记.html.vue"]]);export{r as default};
